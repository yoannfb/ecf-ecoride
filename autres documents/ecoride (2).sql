...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : jeu. 22 mai 2025 à 14:32
...
INSERT INTO `avis` (`id`, `trajet_id`, `auteur_id`, `note`, `commentaire`, `statut`) VALUES
(1, 13, 2, 4, 'Conducteur très ponctuel.', 'en attente');
...
INSERT INTO `trajets` (`id`, `conducteur_id`, `vehicule_id`, `adresse_depart`, `adresse_arrivee`, `date_depart`, `date_arrivee`, `prix`, `places_disponibles`, `statut`, `probleme`) VALUES
(13, 3, 4, '1 rue de la mairie 74000 annecy', '10 Av. Simone Veil, 69150 Décines-Charpieu', '2025-05-15 14:00:00', '2025-05-15 16:00:00', 1.00, 2, 'à venir', 1);
...
(4, 'moderateur', 'employe@ecoride.fr', 'Employe1333*', 20, 'employe', NULL);
...
--
ALTER TABLE `avis`
  ADD CONSTRAINT `avis_ibfk_1` FOREIGN KEY (`trajet_id`) REFERENCES `trajets` (`id`),
